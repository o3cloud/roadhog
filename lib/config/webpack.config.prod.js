...
exports.default = function (args, appBuild, config, paths) {
  ...
  var finalWebpackConfig = _extends({
    ...
    new _extractTextWebpackPlugin2.default({
      ...
      allChunks: true
    })].concat(_toConsumableArray((0, _common.getCommonPlugins)({
      config: config,
      paths: paths,
      appBuild: appBuild,
      NODE_ENV: NODE_ENV
    })), _toConsumableArray(debug ? [] : [new _uglifyjsWebpackPlugin2.default(uglifyJsPluginConfig)]), _toConsumableArray(analyze ? [new _webpackVisualizerPlugin2.default()] : [])),
